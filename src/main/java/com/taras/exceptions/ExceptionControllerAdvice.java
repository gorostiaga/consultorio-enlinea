...
//    }
    ...
    @ExceptionHandler(value = ServiceNotExistsException.class)
    public final ResponseEntity<String> handleUpdateFailException(ServiceNotExistsException exception){
        return new ResponseEntity<>(exception.getMessage(), HttpStatus.BAD_REQUEST);
    }
